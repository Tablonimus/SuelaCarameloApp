      ...
      <main id="vouchers-wrapper" className="w-full  flex pl-[72px] mt-6 md:w-[800px] lg:w-[950px] lg:mt-12">
        <section id="voucher-boxL" className=" bg-white w-1/2 py-1 pl-1 sm:py-2 sm:pl-2 lg:py-4 lg:pl-4">
          <article id="voucher-title">
            ...
            <p className="text-[#ed7020] font-cursive text-xl -mt-5 mr-2 text-end font-semibold sm:text-3xl sm:mr-12 md:mr-28 lg:mr-10 lg:text-4xl">SuelaApp</p>
          </article>
          <ul id="voucher-info"
          className="text-zinc-900">
            <li className="text-base font-semibold leading-4 mt-1 sm:text-lg lg:text-xl lg:mt-2">Términos y Condiciones</li>
            <li className="font-semibold text-zinc-900 text-lg mt-1 lg:text-xl">
            {sponsor.name}
            </li>
          ...
          <ul id="voucher-contact" className="mt-1 text-sm font-medium flex flex-col gap-[2px] sm:mt-2 lg:flex-row lg:justify-center lg:gap-8 lg:text-lg lg:mt-6">
            <li className="flex items-center lg:border-t-2 lg:border-orange-500 lg:py-1 lg:px-2">
              <i className="bx bxs-phone mr-2 "></i>{sponsor.telefono}
            </li>
            <li className="flex items-center lg:border-t-2 lg:border-orange-500 lg:py-1 lg:px-2">
              <i className="bx bx-target-lock mr-2"></i>{sponsor.ubi}
            </li>
          </ul>
        </section>
        ...
        <section id="voucher-boxR" className="bg-zinc-900 w-1/2 flex flex-col items-center justify-between lg:py-4">
          ...
          <article id="voucher-discount" className= "flex justify-center items-center mb-10 lg:mb-4">
            <span className="text-7xl font-bold text-[#ed7020] lg:text-8xl">{sponsor.descuento}</span>
